...
<div class="table-section">
    ...
    <div class="table-header align-items-start">
        ...
        <div class="table-actions align-items-start">
            <a href="{{ route('admin.layanan_konsultasi.create') }}" class="btn btn-primary tambah-data-btn">
                Tambah Data +
            </a>

            {{-- ================= FORM FILTER ================= --}}
            <form method="GET"
                  action="{{ route('admin.layanan_konsultasi.index') }}"
        ...
        <table class="custom-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $row->perempuan }}</td>
                    <td>
                        <a href="{{ route('admin.layanan_konsultasi.edit', $row->id) }}"
                           class="btn btn-warning btn-sm">Edit</a>

                        <form action="{{ route('admin.layanan_konsultasi.destroy', $row->id) }}"
                              method="POST"
                              class="d-inline">
                            @csrf
                            @method('DELETE')
