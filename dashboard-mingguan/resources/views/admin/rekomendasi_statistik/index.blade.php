...
<div class="table-section">
    <div class="table-header align-items-start">
        ...
        <div class="table-actions align-items-start">
            <a href="{{ route('admin.rekomendasi_statistik.create') }}" class="btn btn-primary tambah-data-btn">Tambah Data +</a>
            <form method="GET" action="{{ route('admin.rekomendasi_statistik.index') }}" class="row g-2 align-items-end ms-3">
                <div class="col-md-4">
                ...
                <div class="col-md-2 d-flex gap-2">
                    ...
                    <a href="{{ route('admin.rekomendasi_statistik.index') }}" class="btn btn-outline-danger">Reset</a>
                </div>
            </form>
        </div>
    </div>
        ...
        <table class="custom-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $row->Total }}</td>
                    <td>
                        <a href="{{ route('admin.rekomendasi_statistik.edit', $row->id) }}" class="btn btn-warning btn-sm">Edit</a>
                        <form action="{{ route('admin.rekomendasi_statistik.destroy', $row->id) }}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
